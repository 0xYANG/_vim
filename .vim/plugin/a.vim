...
call <SID>AddAlternateExtensionMapping('h',"C,c,cpp,cxx,cc,CC")
call <SID>AddAlternateExtensionMapping('H',"C,c,CPP,CXX,CC")
...
" Mappings for Fusion
call <SID>AddAlternateExtensionMapping('flt',"parms")
call <SID>AddAlternateExtensionMapping('parms',"flt")
